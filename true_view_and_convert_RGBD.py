...
print(len(list(pcd_sparse.points)))
...
# val_colors_data = []
# frame_num1 = 300
# for frame in np.linspace(188, 188+frame_num1-1, frame_num1):
#     rgbd2PtsCloud = RGBD2PtsCloud.RGBD2PtsCloud(int(frame))
...
# frame_num2 = 60
# # for frame in np.linspace(136+frame_num1, 136+frame_num1+frame_num2-1, frame_num2):
# for frame in np.linspace(188, 188+frame_num2-1, frame_num2):
#     rgbd2PtsCloud = RGBD2PtsCloud.RGBD2PtsCloud(int(frame))
...
# # SAVE data into hdf5 file
# f = h5py.File("/home/jared/SAIR_Lab/Super-Map/diffusion-point-cloud-main/data/shapenet_overfit_flip.hdf5", "r+")
# # 1. For XYZ pts only 
# print(list(f.keys()))
# hospital_dataset = f['02773838']
# # (1) for 'train' data
